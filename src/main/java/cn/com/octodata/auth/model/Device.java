...
public class Device {
    ...
    private String leaseTime;    // IP地址租期 2h 两小时
    ...
    public Device(String deviceId, String areaId, int disable,
                  String ssid, int ssidHidden, String encryption,
                  String key, String ipAddress, String ipMask,
                  int ignore, int start, int limit,
                  String leaseTime, int autoReboot, String rebootTime) {
